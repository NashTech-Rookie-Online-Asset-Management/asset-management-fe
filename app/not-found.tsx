    ...
    <div className="flex min-h-screen flex-col">
      ...
      <div className="flex flex-1 flex-col items-center justify-center gap-4 md:flex-row">
        ...
        <div className="flex flex-col">
          <h2 className="text-2xl font-black dark:bg-gradient-to-r dark:from-nashblue dark:to-nashred dark:bg-clip-text dark:text-transparent dark:underline dark:decoration-border md:text-4xl">
            Not Found
          </h2>
